...
export class Backend implements backendInterface {
    ...
    async addMod(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addMod(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async deleteMod(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getMod(arg0: string): Promise<Mod> {
        if (this.processError) {
            try {
    ...
    async listMods(): Promise<Array<Mod>> {
        if (this.processError) {
            try {
                const result = await this.actor.listMods();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async toggleModEnabled(arg0: string): Promise<void> {
        if (this.processError) {
            try {
